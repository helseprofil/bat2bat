...
usethis::use_mit_license( name = "ybka" )  # You can set another licence here
...
usethis::use_data_raw( name = "kom2020", open = FALSE ) # Change "my_dataset"
usethis::use_data_raw( name = "mixFil", open = FALSE ) # Change "my_dataset"
